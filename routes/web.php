...
Route::middleware('check.role:front office,dokter,beautician')->group(function () {
    ...
    Route::middleware('check.role:kasir')->group(function () {
        ...
        Route::get(
            '/penjualan-produk/{paymentId}/invoice',
        ...
        Route::put(
            '/penjualan-produk/{id}/pembayaran',
            [PembelianProdukController::class, 'updatePayment']
        )->name('pembelian-produk.updatePayment');

        // Route untuk halaman pembelian produk
        Route::get('/penjualan-produk', [PembelianProdukController::class, 'index'])->name('pembelianProduk.index');
        ...
        Route::post('penjualan-produk/store', [PembelianProdukController::class, 'store'])->name('pembelian-produk.store'); // Menyimpan data pembelian
        Route::get('/penjualan-produk/{id}', [PembelianProdukController::class, 'show'])->name('pembelian-produk.show'); // Rute untuk menampilkan detail pembelian produk
        Route::get('/penjualan-produk/{id}/edit', [PembelianProdukController::class, 'edit'])->name('pembelian-produk.edit');
        Route::put('/penjualan-produk/{id}', [PembelianProdukController::class, 'update'])->name('pembelian-produk.update');
        Route::delete('/penjualan-produk/{id}/destroy', [PembelianProdukController::class, 'destroy'])->name('pembelian-produk.destroy');
        Route::put('/penjualan-produk/{id}/status', [PembelianProdukController::class, 'updateStatus'])->name('pembelian-produk.updateStatus');
