...
class KategoriController extends Controller
{
    public function index()
    {
        ...
        $response = Http::get('https://klinikneshnavya.com/api/kategori/');
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::post("https://klinikneshnavya.com/api/kategori", $data);
    ...
    {
        $response = Http::get("https://klinikneshnavya.com/api/kategori/{$id}");
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::put("https://klinikneshnavya.com/api/kategori/{$id}", [
    ...
    {
        $response = Http::delete("https://klinikneshnavya.com/api/kategori/{$id}");
