...
@section('content')
    ...
    <h1 class="h3 mb-2 text-gray-800">Feedback Treatment</h1>

    <!-- Feedback List -->
    <div class="card shadow mb-4">
        <div class="card-body">
            <table id="listFeedbackTreatment" class="table table-bordered" width="100%" cellspacing="0">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($feedbacks as $feedback)
                        <tr>
                            <td style="display:none">{{ $feedback['id_feedback_treatment'] }}</td>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                $('#listFeedbackTreatment').DataTable({
                    responsive: true,
                    pageLength: 25,
                    lengthMenu: [
                        [10, 25, 50, 100],
